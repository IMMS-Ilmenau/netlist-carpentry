...
from netlist_carpentry.io.read.yosys_netlist_types import AllYosysTypes, BitAlias, YosysCell, YosysData, YosysModule
from netlist_carpentry.utils._gate_lib_base import _EnMixin
...
class YosysNetlistReader(AbstractReader):
    ...
    def transform_to_circuit(self, name: str = '') -> Circuit:
        ...
        for mname in modules_dict['modules']:
            self.circuit.module_instances[mname] = []
    ...
    def _build_instance_ports_direction(self, pdirs: Dict[str, str], pname: str) -> Direction:
